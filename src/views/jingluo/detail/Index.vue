            ...
            <div class="cover-header">
              ...
              <div class="cover-collect-author">
                <router-link
                  ...
                  :to="{ path: '/layouts/music/singer', query: { id: item.userId } }">
        ...
        <div v-if="comments.length" class="playlist-comment">
          ...
          <div class="aside-main comment-main">
            <div v-for="item in comments" :key="item.commentId" class="comment-item">
              <router-link :to="{ path: '/layouts/music/user', query: { id: item.commentId } }">
              ...
              <div class="comment-info">
                <div class="comment-userInfo"
                  ><router-link :to="{ path: '/layouts/music/user', query: { id: item.commentId } }" class="comment-name">{{
                    item.user.nickname
                  }}</router-link
