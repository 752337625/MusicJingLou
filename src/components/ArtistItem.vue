<template>
  <div class="item">
    <em class="circle"></em>
    <router-link :to="{ path: '/layouts/music/singer', query: { id: item.id } }" class="faceImg">
    ...
    <div class="info">
      <div class="info-header">
        <router-link :to="{ path: '/layouts/music/singer', query: { id: item.id } }" class="name">{{ item.name }}</router-link>
